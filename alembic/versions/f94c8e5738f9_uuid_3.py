...
Revision ID: f94c8e5738f9
Revises: 08da76725c1a
Create Date: 2023-04-15 17:42:49.050534
...
revision = 'f94c8e5738f9'
down_revision = '08da76725c1a'
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['producer_id'], ['users.id'], name='employees_events_producer_id_fkey'),
